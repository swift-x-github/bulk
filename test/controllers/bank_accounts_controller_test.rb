...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { balance_cents: @bank_account.balance_cents, bic: @bank_account.bic, iban: @bank_account.iban, organization_name: @bank_account.organization_name } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { balance_cents: @bank_account.balance_cents, bic: @bank_account.bic, iban: @bank_account.iban, organization_name: @bank_account.organization_name } }
